 ...
 *
 *  Note: ERROR_ASSERT_ABORT will enable assert without abort. ERROR_ASSERT
 *  should be disabled to enable ERROR_ASSERT_ABORT (ERROR_ASSERT overrides
 *  ERROR_ASSERT_ABORT)
 */
...
/*
 * Maximum size of ring buffer. This value can be modified by application as per platform and
